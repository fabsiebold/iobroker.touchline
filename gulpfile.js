...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new touchline name, like: "gulp rename --name mywidgetset" --author "Fabian Siebold"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/touchline.png')) {
        fs.renameSync(__dirname + '/admin/touchline.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/touchline.html')) {
        fs.renameSync(__dirname + '/widgets/touchline.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/touchline/js/touchline.js')) {
        fs.renameSync(__dirname + '/widgets/touchline/js/touchline.js', __dirname + '/widgets/touchline/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/touchline')) {
        fs.renameSync(__dirname + '/widgets/touchline',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /touchline/g,
        ...
        {
            match: /Touchline/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Touchline'
        },
        {
